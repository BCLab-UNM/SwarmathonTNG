...
## Overview
This repository contains Swarmathon TNG based on Cabrillo College’s 2018 & 2019 submissions to the [NASA Swarmathon](http://www.nasaswarmathon.com), a national swarm robotics competition.
...
2. Install dependencies, clone and build.
    ...
    git clone --recursive git@github.com:BCLab-UNM/SwarmathonTNG.git
    cd SwarmathonTNG
    catkin build
